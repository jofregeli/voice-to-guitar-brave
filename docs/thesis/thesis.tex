...
%  Author: Jofre Geli de Fuenmayor             Submission: 14 June 2026
%
...
\begin{table}[H]
\centering
\caption{Three-phase schedule of the active iteration cycle (24~March -- 14~June 2026), following the UPF TFG guide \parencite{hernandezleo2012tfg}. December 2025 -- 23~March 2026 was an earlier scoping and first (unsuccessful) environment-setup phase, described above. Phase boundaries correspond to the dated training runs in the project repository.}
\label{tab:phases}
\begin{tabular}{lccc}
\toprule
...
Final (writing + defence preparation) & 3 weeks & $\sim$30\,\% & 22 May -- 14 June \\
\bottomrule
\end{tabular}
\end{table}
...
Table~\ref{tab:gantt} renders the active iteration cycle of Table~\ref{tab:phases} as a Gantt chart, mapping the principal tasks to the twelve weeks between 24~March and 14~June 2026 and to the three project phases. Shaded cells indicate the weeks of active work on each task; phase boundaries are approximate at the weekly resolution shown.

\begin{table}[H]
\centering
\caption{Gantt chart of the active iteration cycle (24~March -- 14~June 2026). Shaded cells mark weeks of active work on each task; the phase bands follow the schedule of Table~\ref{tab:phases}.}
\label{tab:gantt}
\footnotesize
