...
\begin{table}[H]
\centering
\caption{Three-phase schedule of the active iteration cycle (24~March -- 12~June 2026), following the UPF TFG guide \parencite{hernandezleo2012tfg}. December 2025 -- 23~March 2026 was an earlier scoping and environment-rebuild phase, described above.}
\label{tab:phases}
\begin{tabular}{lccc}
\toprule
