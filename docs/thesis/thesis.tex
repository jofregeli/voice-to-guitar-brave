...
Table~\ref{tab:gantt} renders the active iteration cycle of Table~\ref{tab:phases} as a Gantt chart, mapping the principal tasks to the twelve weeks between 24~March and 12~June 2026 and to the three project phases. Shaded cells indicate the weeks of active work on each task; phase boundaries are approximate at the weekly resolution shown.

\begin{table}[H]
\centering
\caption{Gantt chart of the active iteration cycle (24~March -- 12~June 2026). Shaded cells mark weeks of active work on each task; the phase bands follow the schedule of Table~\ref{tab:phases}.}
\label{tab:gantt}
\footnotesize
