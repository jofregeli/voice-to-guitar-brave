...
| W4 | 13–19 April | Execution | **guitar_v1** launched (`c128_r10.gin`, unmodified). Diagnostic confirmed posterior collapse: KL fell 0.83 → 0.25, forward diff 0.006. Lesson logged: log-space β warmup required. |
